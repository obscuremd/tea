...
export const AuthDropdown: React.FC<Props> = ({ dropdown, setDropdown, data, icon, truncate, zIndex, setData, placeholder }) => {
  ...
  return (
      ...
      <motion.button
        ...
        >
            ...
            <input type="text" onClick={()=>setDropdown(!dropdown)} className="w-full border-transparent flex items-center justify-center text-center" value={inputValue} placeholder={placeholder} onChange={(e)=>setInputValue(e.target.value)}/>
