...
router.post('/register', async(req, res) => {
    const {username, fullName, email, profilePicture, coverPicture, location, gender, bio}=req.body

    try {
        const user = await User.create({username, fullName, email, profilePicture, coverPicture, location, gender, bio})
